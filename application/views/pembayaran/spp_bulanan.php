                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo anchor('pembayaran/hapus/' . $u->id_transaksi . '/' . $u->nisn . '/' . $id_pem_bulan, '<input type=reset class="btn btn-danger" value=\'Hapus\'>'); ?> <br>

                                            <?php
                                            #untuk cek status transaksi
                                            if ($u->status == '1' || $u->status == '2') {
                                                echo '<a href="javascript:void(0)" onclick="cekStatusTransaksi(\'' . $u->id_transaksi . '\',\'' . $u->nisn . '\',\'' . $u->order_id . '\')"><input type=reset class="btn btn-warning" value=\'Cek Transaksi\'></a>';
                                            }
                                            ?>
                                        </td>
                                        <?php { ?>
            ...
            <div class="card-content">
                ...
                <?php foreach ($santri as $u) { ?>
                    <form id="form-spp" class="form-inline" method="post" action="<?= base_url('pembayaran/tambah_aksi'); ?>">
                        ...
                        <input name="nisn" id="nisn" class="form-control" type="text" value="<?php echo $u->nisn ?>" hidden>
                        <input name="nama" id="nama" class="form-control" type="text" value="<?php echo $u->nama ?>" hidden>
                        ...
                        <div class="form-group col-12">
                            <!--<div class="col-lg-5">-->
                            <label>Bulan</label>
                            <select class="bootstrap-select strings selectpicker" title="Bulan" name="bulan[]" id="bulan" data-actions-box="true" data-virtual-scroll="false" data-live-search="true" multiple required>
                                <?php
...
<script type="text/javascript">
    ...
    function cekStatusTransaksi(_idtransaksi, _nisn, _orderid) {
        $.ajax({
            type: 'POST',
            url: '<?= base_url() ?>snap/cekStatusTransaksi/' + _idtransaksi + '/' + _nisn + '/' + _orderid,
            data: {},
            cache: false,
